...
const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    faqs: [
      ...
      {
        question: '募集の内容はどこまで確認できますか？',
        answer:
          '施術メニューや料金、所要時間、注意事項などが募集詳細から一目で確認できます。不明点がある場合はチャットから気軽にお問い合わせください。',
      },
      {
      ...
      {
        question: '来店時に学生証は必要ですか？',
        answer:
          '多くのサロンでは来店時に学生証の提示をお願いしています。スムーズなご案内のためにも、当日は必ず学生証をご持参ください。',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          'サロン向けアカウントでログイン後、ダッシュボードの「募集を作成」から施術メニュー、料金、募集人数、対応可能日時などを直感的に入力して公開できます。複数の日時指定や、文章で柔軟に対応可能な時間帯を記載することも可能です。',
      },
      {
      ...
      {
        question: '学生からの仮予約はどのように管理できますか？',
        answer:
          '仮予約ごとに学生のプロフィールと希望内容を確認した上で、承認またはやむを得ない場合のキャンセルをワンクリックで操作できます。処理結果は学生側にも即時反映されます。',
      },
      {
      ...
      },
      {
        ...
        answer:
          'サロン向けの基本機能はベータ期間中、すべて無料でご利用いただけます。今後、有料オプション（優先表示や分析機能など）の導入を予定していますが、導入時には事前にご案内いたします。',
      },
    ],
  },
  {
